package dev.kiwik.tracking.domain

import com.squareup.moshi.Moshi
import dev.kiwik.tracking.domain.api.ApiError
import dev.kiwik.tracking.domain.api.IRestService
import dev.kiwik.tracking.domain.api.RetrofitClient
...
object ApiUtils {
    ...
    private fun buildIRestService(): IRestService {
        val token = "" //WandoSession.getInstance().values.loggedUser?.token
